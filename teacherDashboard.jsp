...
<body>
                ...
                <thead>
                    <tr>
                       ...
                       <th style="width: 20%;">Student Name</th>
                        ...
                        <th style="width: 15%;">Overall Performance (%)</th>
    ...
    <c:forEach var="student" items="${studentList}">
        <tr>
            ...
            <td>
                ${student.performance}% 
                <span class="dot ${student.performance >= 40 ? 'blue' : 'gray'}"></span>
            </td>
            <td>
                ${student.attendance}% 
                <span class="dot ${student.attendance >= 75 ? 'blue' : 'gray'}"></span>
            </td>
        </tr>
    </c:forEach>
    ...
    <c:if test="${empty studentList}">
        <tr>
            <td colspan="4" style="text-align: center; padding: 20px;">No students found in the database.</td>
        </tr>
    </c:if>
</tbody>
            </table>
