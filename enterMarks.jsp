...
<body>
    ...
    <div class="sidebar">
        ...
        <nav>
            ...
            <li class="nav-item active">
                    <a href="#"><i class="fas fa-pencil-alt"></i>  Enter Marks</a>
                </li>  
    ...
    <div class="main-content">
        <div class="header">
                 <center><h1>Enter Marks</h1></center>
    ...
    <div id="success-message" style="background-color: #d4edda; color: #155724; padding: 15px; border-radius: 5px; margin-bottom: 20px; text-align: center; border: 1px solid #c3e6cb;">
        <i class="fas fa-check-circle"></i> Marks uploaded successfully!
    </div>
</c:if>
    <div class="marks-card">
        <form action="SaveMarksServlet" method="post">
            <div class="selection-bar">
                ...
                <select class="custom-select" name="subject_id" onchange="window.location.href='FetchStudentsServlet?subject_id='+this.value">
    <option value="1" ${selectedSubject == '1' ? 'selected' : ''}>Subject: DBMS</option>
    <option value="2" ${selectedSubject == '2' ? 'selected' : ''}>Subject: TOC</option>
    <option value="3" ${selectedSubject == '3' ? 'selected' : ''}>Subject: IWT</option>
    <option value="4" ${selectedSubject == '4' ? 'selected' : ''}>Subject: OS</option>
</select>
        ...
        <table class="marks-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 30%;">TEST MARKS</th>
                         <th style="width: 30%;">MID-SEM MARKS</th>
                              <th style="width: 30%;">ASSIGNMENT MARKS</th>
                                  <th style="width: 30%;">PRACTICAL MARKS</th>
                </tr>
            </thead>
        ...
        <tbody>
            <c:forEach var="student" items="${studentList}">
                <tr>
                    ...
                    <td><input type="number" name="test_${student.id}" value="${student.test}" class="mark-input"></td>
                    <td><input type="number" name="mid_${student.id}" value="${student.mid}" class="mark-input"></td>
                    <td><input type="number" name="assign_${student.id}" value="${student.assign}" class="mark-input"></td>
                    <td><input type="number" name="prac_${student.id}" value="${student.prac}" class="mark-input"></td>
                </tr>
            </c:forEach>
        </tbody>
        </table>
