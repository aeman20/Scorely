    ...
    <div class="sidebar">
        ...
        <nav>
            ...
            <li class="nav-item active">
                    <a href="#"><i class="fas fa-pencil-alt"></i>  Add Student</a>
                </li>  
            ...
            <div class="form-grid">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="phone" class="form-control" placeholder="10-digit number" pattern="[0-9]{10}" title="please enter exactly 10 digits" maxlength="10" required>
                </div>

                <div class="form-group full-width">
                    <label><i class="fas fa-user-friends"></i> Father's Name</label>
                    <input type="text" name="fatherName" class="form-control" placeholder="Father's full name" required>
                </div>

                <div class="form-group">
                    <label><i class="fas fa-envelope"></i> Email Address</label>
                    <input type="email" name="email" class="form-control" placeholder="email@school.com" required>
                </div>
                ...
                <div class="form-group full-width">
                    <button type="submit" class="reg-btn">Create Student Account</button>
                </div>
